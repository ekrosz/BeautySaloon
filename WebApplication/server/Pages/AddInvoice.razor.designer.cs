...
namespace WebApplication.Pages
{
    public partial class AddInvoiceComponent : ComponentBase
    {
        ...
        {
            var request = Mapper.Map<CreateInvoiceRequestDto>(Invoice);

            var isSuccess = await HttpClientWrapper.SendAsync((accessToken) => InvoiceHttpClient.CreateAsync(accessToken, request, CancellationToken.None));
